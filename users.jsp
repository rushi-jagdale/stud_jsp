...
try
{
	out.println("I am in Add");
	Class.forName("com.mysql.jdbc.Driver");
	java.sql.Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/myadmin",
	"mis_user","india#123");
	Statement st= con.createStatement();
	ResultSet rs;
	String sql="insert into users(id,Fullname,Email,Password) values (0,'"+Fullname+"','"+Email+"','"+Password+"')";
	out.println(sql);
	...
	String sql="Update users set  Fullname=?,Email=?,Password=? where id="+id;
//	out.println(sql);
		...
		<div class="wrapper">
			...
			<nav class="main-header navbar navbar-expand navbar-white navbar-light">
				...
				<ul class="navbar-nav">
					...
					<li class="nav-item d-none d-sm-inline-block">
						<a href="logout.jsp" class="nav-link">Contact</a>
   ...
   style="opacity: .8">
				...
				<div class="sidebar">
					...
					<div class="user-panel mt-3 pb-3 mb-3 d-flex">
						<div class="image">
							<img src="rushi.jpg" class="img-circle elevation-2" alt="User Image">
						</div>
						<div class="info">
							<a href="#" class="d-block" ><%out.println(Fullname);
								%></a>
							...
							<div class="col-12">
								<div class="card">
									...
									<div class="card-body">
										<table id="example2" class="table table-bordered table-hover">
											...
											<tbody>
												...
												<tr>
													...
													<td><a href='addusers.jsp?id=<%=rs.getString("id")%>&action=update'>edit</a></td>
										...
										<center><a href="addusers.jsp"><h3>Add New User</h3></a> </center>													
									</div>
									<!-- /.card-body -->
								</div>
								<!-- /.card -->
