...
//String txtadd=(String)request.getParameter("add");
out.println(action);
if(action!=null)
{
...
//        String name =(String)request.getParameter("name");
  //      String owner =(String)request.getParameter("owner");
        ...
        String sql="insert into person(name,owner,status) values('"+name+"','"+owner+"','"+status+"')";
        out.println(sql);
     ...
     //   if(id!=null)
        ...
        String sql="Update person set  name=?,owner=?,status=? where id="+id;
...
<div class="wrapper">
        ...
        <div class="row">
          <div class="col-12">
           ...
           <!--  <   div class="card-header">
            ...
            <div class="card">
     <!--  <div class="card-header">
	<h3 class="card-title">DataTable for Owner</h3>
      </div>
 /.card-header -->
	       <%
         String id = request.getParameter("id");
  ...
  <%
   try{
	...
	if(rs.getString("status").equals("active")){%>
	                  <tr>
                          <td style="color:green;"> <%=rs.getString("name") %></td>
                    <td  style="color:green;"> <%=rs.getString("owner") %>
 ...
 %>
		    ...
		    <%}%>
                    <td> <a href='addperson.jsp?id=<%=rs.getString("id")%>&action=update'>edit</a></td>
	...
	e.printStackTrace();
		...
		<center>
		 <a href="addperson.jsp"> add Owner</a>
                </center>
              </div>
              <!-- /.card-body -->
            </div>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2014-2019 <a href="http://adminlte.io">Admin</a>.</strong> All rights
    reserved.
  </footer>
